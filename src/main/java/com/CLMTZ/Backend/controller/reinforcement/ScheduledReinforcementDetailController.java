...
public class ScheduledReinforcementDetailController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<ScheduledReinforcementDetailDTO> findById(@PathVariable Integer id) { return ResponseEntity.ok(service.findById(id)); }
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ScheduledReinforcementDetailDTO> update(@PathVariable Integer id, @RequestBody ScheduledReinforcementDetailDTO dto) { return ResponseEntity.ok(service.update(id, dto)); }
