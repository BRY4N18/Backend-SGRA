...
public class PreferenceController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<PreferenceDTO> findById(@PathVariable Integer id) { return ResponseEntity.ok(service.findById(id)); }
    ...
    @PutMapping("/{id}")
    public ResponseEntity<PreferenceDTO> update(@PathVariable Integer id, @RequestBody PreferenceDTO dto) { return ResponseEntity.ok(service.update(id, dto)); }
